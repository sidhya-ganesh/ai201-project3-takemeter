...
**Volume target:** 220–240 labeled examples to leave buffer after the 70/15/15 train/val/test split (which gives ~30 test examples - enough for meaningful per-class metrics at 3 classes).
